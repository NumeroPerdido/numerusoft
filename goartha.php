...
<body id="home" class="homepage">
    ...
    <section id="goartha-question">
        <div class="container">
            ...
            <button id="share" class="btn btn-facebook" style="display:none;"><i class="fa fa-facebook"> </i>Compartilhe</button>
            <canvas id="canvas" hidden="hidden"></canvas>
            <div class="row">
                <div class="col-sm-4 col-md-12">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="0ms">
                        <ul class="question" id="question" hidden="hidden">
                            <li class="plan-header">
                                ...
                                <div class="plan-name" id="title">
                                   
                                </div>
                            </li>
                            <h4>
                                <li id="resp1" onclick=""></li>
                                <li id="resp2" onclick=""></li>
                                <li id="resp3" onclick=""></li>
                                <li id="resp4" onclick=""></li>
                            </h4>
                        </ul>
                    </div>
                </div>
